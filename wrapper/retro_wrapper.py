...
class RETROWrapper(object):
    ...
    def fit(self):
        ...
        configuration = {
            ...
            "OUTPUT_PATH": "pipeline/output_retro/",
            ...
            "SCHEMA_GRAPH_PATH": "pipeline/output_retro/schema.gml",
            "SCHEMA_JSON_GRAPH_PATH": "pipeline/output_retro/schema.json",
            "GROUPS_FILE_NAME": "pipeline/output_retro/groups.pk",
            "RETRO_VECS_FILE_NAME": "pipeline/output_retro/retrofitted_vectors.wv",
