...
with warnings.catch_warnings():
    ...
    from RETRO.retro_utils import tokenize
...
def output_vectors(term_list, Mk, output_file, datasets_path, with_zero_vectors=True):
    print("Start creating idx embeddings...")
    keys, matrix = create_idx_embeddings(term_list, Mk, datasets_path)
    print("Start keys transformation...")
...
class RETROWrapper(object):
    ...
    def fit(self, input_filename):
        ...
        output_filename = configuration['OUTPUT_PATH'] + 'retro__' + input_filename + '.emb'
